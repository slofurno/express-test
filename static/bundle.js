...
/***/ function(module, exports) {
	...
	function loginController($scope, $state, accountService) {
	    ...
	    $scope.getLogins = function () {
	        ...
	        return request({ method: "GET", url: "/api/account" }).then(function (res) {
...
/***/ function(module, exports) {
	...
	function adsController($scope, authService) {
	    ...
	    authService.getAds().then(function (res) {
	        var _$scope$ads;

	        var ads = res.data;
	        (_$scope$ads = $scope.ads).push.apply(_$scope$ads, _toConsumableArray(ads));
	    }).catch(function (err) {
	        console.error(err);
	    });

	    $scope.submit = function () {
	        return authService.postAd($scope.ad).then(function (res) {
	            var ad = res.data;
	            $scope.ads.push(ad);
	            $scope.ad = {};
	        }).catch(function (err) {
